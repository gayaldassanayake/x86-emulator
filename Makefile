...
main: main.o opcode_extension.o modmr.o reader.o memory.o register.o opcodes/add.o opcodes/mov.o opcodes/and.o opcodes/or.o opcodes/inc.o opcodes/dec.o opcodes/sub.o sib.o utility_functions.o push_pop.o test.o cmp.o xchg.o utility_flag_set.o
	$(CC) $(CXXFLAGS) $(CPPFLAGS) -o emulator.out main.o opcode_extension.o modmr.o reader.o memory.o register.o opcodes/add.o opcodes/mov.o opcodes/and.o opcodes/or.o opcodes/inc.o opcodes/dec.o opcodes/sub.o sib.o utility_functions.o push_pop.o test.o xchg.o cmp.o utility_flag_set.o
